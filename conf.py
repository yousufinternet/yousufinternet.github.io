...
BLOG_AUTHOR = {'en': "Yusuf Mohammad", 'ar': "يوسف محمد"}  # (translatable)
BLOG_TITLE = {"en": "Linux User Diary", "ar": "مذكرات مستخدم لينكس"}  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://yousufinternet.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://yousufinternet.github.io/"
BLOG_EMAIL = "yusuf.mohammad@zoho.com"
BLOG_DESCRIPTION = {
    "en":
    "Here I write down the solutions for day-to-day challenges I face while I am on my computer",
    "ar":
    "تجدون هنا حلولاً للتحديّات التي تواجهني وأنا جالس أمام حاسوبي"}  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "yousufinternet"
